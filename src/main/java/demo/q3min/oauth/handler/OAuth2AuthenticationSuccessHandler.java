...
import demo.q3min.oauth.token.AuthToken;
import demo.q3min.oauth.token.AuthTokenProvider;
import demo.q3min.util.CookieUtil;
...
import static demo.q3min.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static demo.q3min.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
